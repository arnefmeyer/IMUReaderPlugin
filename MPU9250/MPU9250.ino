/* Code to read data from the MPU9250 using a Teensy 3.x.
 *  
 *  The code has been tested with a Teensy 3.2.
 *  
 *  Hardware setup:
 *  sensor -> teensy pin
 *  SCL    -> 19
 ...
 *  GND    -> GND
 *  
 *  It's based on Kris Winer's code (which also includes some calibration functions):
